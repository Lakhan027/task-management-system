...
router.post('/',  rateLimit(rateLimits.strict),asyncHandler(taskController.createTask));
...
router.put('/:id', rateLimit(rateLimits.strict),asyncHandler(taskController.updateTask));
router.patch('/:id/status', rateLimit(rateLimits.strict),asyncHandler(taskController.updateStatus));
router.delete('/:id', rateLimit(rateLimits.strict),asyncHandler(taskController.deleteTask));
router.post('/:id/comments', rateLimit(rateLimits.strict),asyncHandler(taskController.addComment));
